...
export default function Toolbar() {
  ...
  const decoratorButtons = schemaDefinition.decorators.map((decorator: any) => {
    return (
      <button
        key={decorator.name}
        style={{
  ...
  const styleButtons = schemaDefinition.styles.map((style: any) => (
    <button
      key={style.name}
      style={{
  ...
  const listButtons = schemaDefinition.lists.map((list: any) => (
    <button
      key={list.name}
      style={{
