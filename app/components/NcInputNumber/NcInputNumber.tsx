  ...
  const renderLabel = () => {
    return (
      <div className="flex flex-col">
        <span className="font-semibold text-2xl text-neutral-800 dark:text-neutral-200">
          {label}
        </span>
        {desc && (
    ...
    >
      ...
      {availableCount > 0 ? (
        <div className="flex flex-col">
          ...
          {availableCount <= 10 && (
            <p className="font-semibold text-neutral-500 dark:text-neutral-400 mt-2 ml-auto">
              Only <span className="text-red-400">{availableCount}</span> left!
            </p>
          )}
        </div>
      ) : (
