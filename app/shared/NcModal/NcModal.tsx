        ...
        >
          <div className="min-h-screen px-1 text-center md:px-4">
            <Transition.Child
              ...
              leaveTo="opacity-0"
            >
              <Dialog.Panel className="fixed inset-0 bg-neutral-900 bg-opacity-50 dark:bg-opacity-80" />
            </Transition.Child>
            ...
            >
              ...
              >
                <div className="py-4 px-6 text-center relative border-b border-neutral-100 dark:border-neutral-700 md:py-5">
                  <ButtonClose
                    onClick={closeModal}
                    className="absolute left-2 top-1/2 transform -translate-y-1/2 sm:left-4 bg-neutral-50 dark:bg-neutral-700"
                  />
                  {modalTitle && (
                    <Dialog.Title
                      as="h3"
